      ...
      <div className="pt-24 px-4 max-w-xl mx-auto">
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 space-y-6">
          ...
          <section>
            ...
            <p className="mb-2">
              <strong>1.1.</strong> NIB!Koe adalah layanan biro jasa swasta yang
              membantu Pengguna dalam proses pendaftaran Nomor Pokok Wajib Pajak
              (NPWP) secara online melalui sistem Direktorat Jenderal Pajak
              (DJP) Indonesia.
            </p>
            <p>
              <strong>1.2.</strong> Layanan yang Kami sediakan meliputi
              pengisian formulir pendaftaran NPWP, verifikasi data, dan
              pengiriman NPWP elektronik (softcopy) kepada Pengguna setelah
          ...
          <p>
            Dengan menggunakan layanan NIB!Koe, Anda dianggap telah menyetujui
