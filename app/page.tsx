  ...
  const advantages = [
    {
      ...
      desc: "Dapatkan email profesional untuk kredibilitas usaha Anda.",
      icon: <Mail className="text-emerald-600" />,
    },
    {
      title: "Free Cek RDTR",
      desc: "Pengecekan Rencana Detail Tata Ruang agar izin tidak ditolak.",
    ...
    {
      title: "Free Cek Zona Ruang",
      desc: "Analisis zona tata ruang & pemanfaatan lahan secara akurat.",
    ...
    >
      ...
      <section className="py-32 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          >
            <h2 className="text-5xl md:text-7xl font-black tracking-tighter text-emerald-950 uppercase hero-title">
              KELEBIHAN <br />
              <span className="text-emerald-600">NIB!KOE.</span>
            </h2>
            <p className="text-slate-400 font-black uppercase tracking-[0.3em] mt-4">
              Lebih dari sekadar NIB
            </p>
          </motion.div>
          ...
          >
            {advantages.map((adv, i) => (
              ...
              >
                ...
                <h4 className="text-xl font-black text-emerald-950 uppercase tracking-tight mb-4">
                  {adv.title}
                </h4>
